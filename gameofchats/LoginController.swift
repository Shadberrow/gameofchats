...
class LoginController: UIViewController {
    ...
    let inputsContainerView: UIView = {
        ...
        view.layer.masksToBounds = true // to activate corner radius
        return view
    }()
    ...
    func handleLoginRegisterChange() {
        ...
        nameTextField.text = loginRegisterSegmentControl.selectedSegmentIndex == 0 ? "" : nameTextField.text
    ...
    func setupInputsContsinerView() {
        inputsContainerView.centerXAnchor.constraint(equalTo: view.centerXAnchor).isActive = true
        inputsContainerView.centerYAnchor.constraint(equalTo: view.centerYAnchor).isActive = true
        inputsContainerView.widthAnchor.constraint(equalTo: view.widthAnchor, constant: -24).isActive = true // 12px from the left and 12px from the right
        ...
        passwordSeparatorView.topAnchor.constraint(equalTo: emailTextField.bottomAnchor).isActive = true
